...
export const FETCH_HISTORY_CHAT_MESSAGES_BY_PAGING_SUCCESS = 'FETCH_HISTORY_CHAT_MESSAGES_BY_PAGING_SUCCESS'

export const ADD_NOTIFY_MSG = 'ADD_NOTIFY_MSG'
export const CLEAR_NOTIFY_MSG = 'CLEAR_NOTIFY_MSG'
export const ON_ENTER_TYPED_NOTIFY = 'ON_ENTER_TYPED_NOTIFY'

export const FETCH_CONVERSATION = 'FETCH_CONVERSATION'
export const FETCH_CONVERSATION_PAGING = 'FETCH_CONVERSATION_PAGING'