        ...
        <View style={styles.body}>
          <ScrollView>
            ...
            <View style={styles.contentWrap}>
              ...
              <Text style={styles.lineText}>欢迎加入汇邻优店推广联盟，为了推广员信息的真实有效，共建良好的推广环境，推广加盟必须由平台其他推广人员发出邀请才能注册。</Text>
              ...
              <Text style={[styles.lineText, {fontWeight:'bold'}]}>3. 联系客服给您推荐推广员；</Text>
              <Text style={styles.lineText}>点击个人头像进入的个人信息页面，头像下方有以下身份标识均具备生成邀请码资格，您可以通过私信与他沟通获取邀请码</Text>
              <Text style={[styles.lineText, {marginTop: 20,marginBottom: 20}]}>
                若仍有疑问，请
